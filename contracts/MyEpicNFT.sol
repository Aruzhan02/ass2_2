...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["word1", "word2", "word3", "word4", "word5", "word6"];
  string[] secondWords = ["example1", "example2", "example3", "example4", "example5", "example6"];
  string[] thirdWords = ["wword1", "wword2", "wword3", "wword4", "wword5", "wword6"];
